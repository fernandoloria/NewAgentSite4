<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Classic/Report.Master" AutoEventWireup="true" CodeBehind="ErrorHandle.aspx.cs" Inherits="AgentSite4.Report.ErrorHandle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="ErrorDiv">
                <%=ErrorMsg%><br />
                <input type="button" value="Go Back" onclick="window.history.back(<%=Back%>);" />
        </div>
    </center>
            </ContentTemplate>
        </asp:UpdatePanel>
