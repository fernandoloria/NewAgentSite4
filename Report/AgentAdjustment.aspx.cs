...
{
    public partial class AgentAdjustment : BasePage, IRequiresSessionState
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                if (Common.HasRights(ReportPosition.AGENTADJUSTMENT))
                {
                    int prmPage = 1;
                    ...
                    if (this.Request.QueryString["Page"] != null)
                        prmPage = int.Parse(this.Request.QueryString["Page"].ToString());
                    ...
                    CResultAgentPlayerAdjustment playerAdjustment1 = new CResultAgentPlayerAdjustment();
                    CResultAgentPlayerAdjustment playerAdjustment2 = agentInstance.GetReportAgentPlayerAdjustment(prmIdAgent, prmStartDate, prmEndDate, prmPage, prmRecsPerPage, prmIdCurrency);
                    if (playerAdjustment2.ErrorCode == CErrorCode.ErrorNone)
                    {
                        string str = "../App_Themes/" + this.Theme + "/";
                        XmlDocument xmlDocument = new XmlDocument();
                        xmlDocument.LoadXml(playerAdjustment2.ToXml());
                        ...
                        compiledTransform.Load(this.Server.MapPath("..\\App_Themes\\" + this.Theme + "\\xsl\\AgentAdjustment.xsl"));
                    ...
                    else if (playerAdjustment2.ErrorCode == CErrorCode.ErrorValidation)
