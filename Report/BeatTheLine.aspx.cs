...
{
    public partial class BeatTheLine  : BasePage, IRequiresSessionState
    {
        ...
        protected void CreateReport()
        {
            ...
            if (report.Rows.Count > 0)
            {
                ...
                header.Text = "<table style='width: 100%;' cellspacing='0' cellpadding='3' border='0' class='table-dynamic table table-bordered table-striped' align='center'><tbody><tr class='table-title'><td colspan='15'><h4>" + agent + "</h4></td></tr></tbody></table><div class=\"table-responsive\">";
