...
{
    public partial class AgentExposure : BasePage, IRequiresSessionState
    {
        ...
        private void LoadData()
        {
            try
            {
               ...
               AddOnWebClient.Agent agentInstance = new AddOnWebClient.Agent();
                ...
                {
                    CResultAgentExposure cresultAgentExposure = new CResultAgentExposure();
                    ...
                    CResultAgentExposure reportAgentExposure = agentInstance.GetReportAgentExposure(prmIdAgent, str1.Trim(), prmIdCurrency);
                    if (reportAgentExposure.ErrorCode == CErrorCode.ErrorNone)
                    {
                        ...
                        compiledTransform.Load(this.Server.MapPath("..\\App_Themes\\" + this.Theme + "\\xsl\\AgentExposure.xsl"));
