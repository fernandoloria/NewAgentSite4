...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//xml">
		...
		<input type="hidden" value="{@IdPlayer}" name="hPlayer" id="hPlayer" />
		<input type="hidden" value="{@CurrentBalance}" name="hBalance" id="hBalance" />
		<input type="hidden" value="{@FreePlayAmount}" name="hFreePlay" id="hFreePlay" />
		...
		<center>
			<xsl:if test="@Player != 'N/A'">
				...
				<input type="button" class="btn btn-primary" value="Submit" onclick="respConfirmPopUp();" />
	...
	<xsl:template name="Info">
		<div class="form-horizontal">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input TYPE="text" class="form-control form-control-sm" maxlenght="10" name="txtAmount" id="txtAmount" value="0.00" />
				</div>
			</div>
